...
@section('title', 'User - Edit - Company')
@push('styles')
@endpush
@section('content')
    <!-- Container -->
    <div class="container py-4">
        ...
        <div class="card shadow-sm border-0 rounded-4">
            ...
            <div class="card-header bg-white border-bottom-0 d-flex justify-content-between align-items-center pt-4 px-4">
                ...
                <a href="{{ route('user.company.index') }}" class="btn btn-outline-secondary btn-sm rounded-pill">
                    ← Back
                </a>
            </div>
            <!-- End of Card Header -->
...
@push('scripts')
    ...
    <!-- External Script  -->
    <script type="text/javascript" src="{{ asset('backend/js/user/edit.js') }}"></script>
